...
public class MainActivity extends Activity {
	Class<?>[] names = new Class[] { GridLayoutTest.class, CheckButtonTest.class,
			ToggleButtonTest.class, ClockTest.class, ChronometerTest.class,
			ImageViewTest.class, SimpleListViewTest.class,
			ArrayAdapterTest.class, ExpandableListViewTest.class,
			SearchViewTest.class, AlertDialogTest.class, DateDialogTest.class,
			MenuTest.class, ContextMenuTest.class, ActionBar_TabNav.class ,PreferenceActivityTest.class
